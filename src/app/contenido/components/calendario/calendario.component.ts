...
export class CalendarioComponent implements OnInit {
  ...
  public obtenerPaciente() {
    ...
    this._usuarioService.getUsuarioById(usuario).subscribe({
      ...
      complete: () => {
        ...
        if (this.usuario) {
          this._pacientesService.getPacienteByUserName(this.usuario.id!).subscribe({
            next: (data: Paciente) => {
              this.paciente = data;
  ...
  public clickDay(day: any) {
    ...
    this.obtenerDatos(this.paciente.dni);
  ...
  public obtenerDatos(dni: string) {
    ...
    this._ciclosAntibioticosService
      .getCicloAntibioticosByDniFecha(
        dni,
        this.dateValue._i
      )
      .subscribe({
  ...
  public marcarFechas(dni: string) {
    ...
    this._datosRespiratoriosService.getDatosRespiratoriosIdUsuario(this.usuario.id!).subscribe({
      next: (data: DatosRespiratorios[]) => {
